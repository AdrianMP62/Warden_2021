...
###Stacked abundance column plots for Warden + Gore system waterbirds
```{r}
WG.stack <- input.data
...
WG.stack.agg$SurvOrd <- as.numeric(str_replace_all(WG.stack.agg$SurvOrd, c("Feb-2008" = "1", "Feb-2010" = "2", "Feb-2011" = "3", "Feb-2012" = "4", "Feb-2013" = "5", "Feb-2014" = "6", "Feb-2015" = "7", "Feb-2016" = "8", "Feb-2017" = "9", "Feb-2018" = "10", "Feb-2019" = "11", "Feb 2021" = "12", "Oct-2006" = "1", "Oct-2007" = "2", "Nov-2008" = "3", "Nov-2009" = "4", "Nov-2010" = "5", "Dec-2011" = "6", "Oct-2012" = "7", "Nov-2013"= "8", "Nov-2014" = "9", "Nov-2015" = "10", "Nov-2016" = "11", "Nov-2017" = "12", "Nov-2018" = "13", "Nov-2019" = "14", "Nov-2020" = "15")))
```

```{r}
WG.stack.NBS <- filter(WG.stack, CommonName != "Banded Stilt")
WG.stack.NBS.agg <- aggregate(data=WG.stack.NBS, Count ~ Group + Survey + Season, FUN="sum") #aggregate count data by species and survey
write.csv(WG.stack.NBS.agg, "./outputs/WGNBS.csv")
```
...
ggplot(Wdepths_Ward, aes(x=doy, y=Warden, color=year)) + 
  geom_line() +
  geom_point(cex = 4) +
  scale_color_manual(values=c('grey','grey',"grey",'grey','grey','grey','grey','grey','grey','grey','grey','grey','grey','green','grey',"grey",'grey','grey','blue','red')) +
